# keypad_uasyncio_hat.py
# https://github.com/BrendanSimon/micropython_experiments/blob/master/keypad/keypad_uasyncio.py

# code as found for other hardware.being adapted for the RS485 CAN HAT hardware.
# I have now removed items which have been replaced.
...
async def keypad_watcher(keypad):
    ...
    while True:
        ...
        #print("queue size:",keypad.queue.qsize())
